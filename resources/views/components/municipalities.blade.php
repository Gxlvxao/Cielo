...
$municipalities = [
    [
        'name' => 'Lisboa',
        'description' => 'Capital sophistication meets Atlantic charm',
        'image' => 'lisboa.jpg',
    ],
    [
        'name' => 'Porto',
        'description' => 'Historic grandeur along the Douro River',
        'image' => 'porto.jpg',
    ],
    [
        'name' => 'Coimbra',
        'description' => 'Academic heritage and cultural richness',
        'image' => 'coimbra.jpg',
    ],
    [
        'name' => 'Braga',
        'description' => 'Ancient beauty with modern vitality',
        'image' => 'braga.jpg',
    ],
    [
        'name' => 'Faro',
        'description' => 'Algarve luxury and coastal elegance',
        'image' => 'faro.jpg',
    ],
    [
        'name' => 'Leiria',
        'description' => 'Medieval charm in central Portugal',
        'image' => 'leiria.jpg',
    ],
];
@endphp
    ...
    <div class="container mx-auto px-4">
        <div class="text-center max-w-3xl mx-auto mb-16 animate-fade-up">
            <div class="inline-block px-4 py-1 bg-accent/10 rounded-full mb-6">
                <span class="text-accent text-sm font-medium">Top Destinations</span>
            </div>
            <h2 class="font-heading text-4xl md:text-5xl font-bold mb-6 text-foreground">
                Most Sought-After Municipalities
            </h2>
            <p class="text-lg text-muted-foreground">
                Explore Portugal's most valued regions for investment and lifestyle
            </p>
        </div>
                ...
                <div class="aspect-[4/3] relative">
                    ...
                    <div class="absolute inset-0 flex flex-col justify-end p-6 text-white">
                        ...
                        <div class="flex items-center gap-2 text-accent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            <span class="text-sm font-medium">View Properties</span>
