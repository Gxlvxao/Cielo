...
@php
// Define as classes baseado no estado ativo/inativo
$classes = ($active ?? false)
            ? 'flex items-center gap-3 px-3 py-2.5 rounded-lg bg-cielo-terracotta text-white shadow-md transition-all group'
            : 'flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-400 hover:bg-white/5 hover:text-white transition-all group';

// Mapa de ícones SVG para manter o HTML limpo
$icons = [
    ...
    'check-badge' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>',
