        ...
        <div class="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div class="animate-fade-up">
                <div class="inline-block px-4 py-1 bg-accent/10 rounded-full mb-6">
                    <span class="text-accent text-sm font-medium">About Crow Global</span>
                </div>
                ...
                <p class="text-lg text-muted-foreground mb-6 leading-relaxed">
                    Crow Global Investments connects international capital to exceptional properties
                    across Portugal, delivering a boutique consulting experience with complete
                    transparency.
                </p>
                <p class="text-lg text-muted-foreground mb-8 leading-relaxed">
                    Our deep market knowledge, combined with exclusive access to off-market
                    opportunities, ensures our clients discover investments that truly match their
                ...
                <div class="grid grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="text-center">
                        ...
                        <div class="text-sm text-muted-foreground">Assets Managed</div>
                    </div>
                    <div class="text-center">
