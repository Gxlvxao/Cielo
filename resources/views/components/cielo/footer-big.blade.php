<footer class="relative min-h-screen flex flex-col justify-between text-white bg-cielo-dark overflow-hidden">
    ...
    <div class="flex-grow flex items-center justify-center relative z-10 px-6 pt-20 pb-10">
        <div class="text-center max-w-4xl mx-auto">
            ...
            {{-- Botão com Animação Corrigida (Slide Suave) --}}
            <a href="{{ route('pages.contact') }}" class="group relative inline-flex h-14 w-64 items-center justify-center overflow-hidden rounded-full bg-white font-bold text-cielo-dark shadow-xl hover:shadow-2xl transition-all duration-300">
                <span class="absolute inset-0 flex items-center justify-center uppercase tracking-[0.2em] transition-transform duration-300 ease-out group-hover:-translate-y-full">
                    {{ __('footer.cta') }}
                </span>
                <span class="absolute inset-0 flex items-center justify-center uppercase tracking-[0.2em] text-cielo-terracotta transition-transform duration-300 ease-out translate-y-full group-hover:translate-y-0">
                    {{ __('footer.cta') }}
                </span>
            </a>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 text-sm">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="https://www.facebook.com/casablancaproperty" target="_blank" class="text-white/60 hover:text-white transition-colors"><span class="sr-only">Facebook</span><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg></a>
                ...
                <div class="space-y-4 text-white/60">
                    ...
                    <p>Avenida da Liberdade 245 - 4A, 1250-143 Lisboa</p>
                    <p>+351 920 383 259</p>
                    <p>info@cielo.pt</p>
                    <p class="text-xs pt-2">9-19H (fechado ao domingo)</p>
                </div>
                ...
                {{-- Coluna 4: Livro de Reclamações (Apenas Link) --}}
                <div class="flex flex-col items-start gap-4">
                    <a href="https://www.livroreclamacoes.pt" target="_blank" class="text-white/60 hover:text-white transition-colors text-sm border-b border-white/20 pb-1 hover:border-white">
