...
<head>
    ...
    <title>{{ isset($title) ? $title . ' - ' . config('app.name', 'Crow Global') : config('app.name', 'Crow Global') }}</title>
    <meta name="description" content="{{ $description ?? 'Premium Real Estate Investments in Portugal. Exclusive off-market properties and boutique consulting.' }}">

    {{-- OPEN GRAPH (Social Media) --}}
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="{{ isset($title) ? $title . ' - ' . config('app.name') : config('app.name') }}">
    <meta property="og:description" content="{{ $description ?? 'Premium Real Estate Investments in Portugal.' }}">
    ...
    <style>
        ...
        /* Scrollbar Personalizada e Moderna */
