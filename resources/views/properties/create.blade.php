            ...
            <form method="POST" action="{{ route('properties.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="title" value="{{ old('title') }}" required class="w-full rounded-lg border-gray-300 focus:border-accent focus:ring-accent" placeholder="{{ __('messages.title_placeholder') }}">
                                    @error('title') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('messages.description_label') }}</label>
                                    <textarea name="description" rows="5" required class="w-full rounded-lg border-gray-300 focus:border-accent focus:ring-accent" placeholder="{{ __('messages.description_placeholder') }}"></textarea>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('messages.condition_label') }}</label>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div>
                                    <label class="block text-xs font-medium text-gray-500 uppercase">{{ __('messages.energy_rating') }}</label>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            <h3 class="text-lg font-bold text-graphite mb-4 border-b pb-2">{{ __('messages.location') }}</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="district" class="w-full rounded-lg border-gray-300 focus:border-accent focus:ring-accent" placeholder="{{ __('messages.district_placeholder') }}">
                                </div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            <h3 class="text-lg font-bold text-graphite mb-4 border-b pb-2">{{ __('messages.media_contact') }}</h3>
                            
                            <div class="mb-4">
                                <label class="block text-sm font-bold text-accent mb-2">{{ __('messages.cover_image_label') }}</label>
                                <div class="border-2 border-dashed border-accent/30 bg-accent/5 rounded-lg p-4 text-center hover:bg-accent/10 transition-colors">
                                    ...
                                    <p class="text-xs text-gray-500 mt-2">{{ __('messages.cover_image_desc') }}</p>
                                </div>
                                @error('cover_image') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                            </div>

                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.gallery_label') }}</label>
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:bg-gray-50 transition-colors">
                                    ...
                                    <p class="text-xs text-gray-400 mt-2">{{ __('messages.gallery_desc') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-xs text-gray-500 mt-1">{{ __('messages.video_desc') }}</p>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-xs text-gray-500 mt-1">{{ __('messages.whatsapp_desc') }}</p>
                            </div>
                        </div>
